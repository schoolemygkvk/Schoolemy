...
const Paymenthistory = () => {
  ...
  const fetchPaymentData = useCallback(async () => {
    ...
    try {
      ...
      const response = await api.get('/calculate-admin-payments', {
        headers,
      });
        ...
        <div style={styles.header}>
          ...
          <div style={styles.headerContent}>
            <h1 style={styles.title}>
              <FaFileInvoiceDollar /> Admin Payment History
            </h1>
            <p style={styles.subtitle}>
              View payment calculations and commission details for tutors
            </p>
          </div>
        </div>
          ...
          <>
            ...
            <div style={styles.infoCard}>
              ...
              >
                ...
                <div style={styles.infoContent}>
                  <div style={styles.infoLabel}>Total Purchase Amount</div>
              ...
              >
                ...
                <div style={styles.infoContent}>
                  <div style={styles.infoLabel}>Total Commission</div>
                  ...
                  <div>
                    {paymentData.tutors && paymentData.tutors.length > 0 ? (
                      ...
                      <div style={styles.noData}>
                        ...
                        <div style={styles.noDataText}>No tutors found</div>
                        <div style={styles.noDataSubtext}>
                          No payment data available for tutors in this period.
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={styles.tableWrapper}>
                    {paymentData.paymentDetails && paymentData.paymentDetails.length > 0 ? (
                      <table style={styles.table}>
                        <thead style={styles.tableHeader}>
                          <tr>
                            ...
                            <th style={styles.tableHeaderCell}>Tutor</th>
                            <th style={styles.tableHeaderCell}>Course</th>
                            <th style={styles.tableHeaderCell}>Student</th>
                            <th style={styles.tableHeaderCell}>Purchase Amount</th>
                        ...
                        <tbody>
                          {paymentData.paymentDetails.map((payment, index) => (
                            <tr
                            ...
                            >
                              ...
                              <td style={styles.tableCell}>
                                <div style={{ fontWeight: '600' }}>{payment.tutorName || 'N/A'}</div>
                              ...
                              <td style={styles.tableCell}>
                                {formatPeriod(payment.paymentPeriod)}
                              </td>
                              <td style={styles.tableCell}>
                      ...
                      <div style={styles.noData}>
                        ...
                        <div style={styles.noDataText}>No payment details found</div>
                        <div style={styles.noDataSubtext}>
                          No payment records available for this period.
                        </div>
                      </div>
                    )}
                  </div>
