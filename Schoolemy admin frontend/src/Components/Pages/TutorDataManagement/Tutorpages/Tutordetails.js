    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to fetch tutors. Please try again.",
      );
    } finally {
      setLoading(false);
    }
              ...
              >
                  ...
                  <div style={styles.infoRow}>
                    ...
                    <span
                      style={{
                        ...styles.statusBadge,
                        ...styles[
                          `status${getStatusClass(tutor.subscriptionStatus).charAt(0).toUpperCase() + getStatusClass(tutor.subscriptionStatus).slice(1)}`
                        ],
                      }}
                    >
                ...
                <div style={styles.cardFooter}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(`/schoolemy/create-tutors/${tutor._id}`)
                    }
                    title="Edit Tutor"
                  >
                    Edit
                ...
                <div style={styles.profileDetails}>
                  ...
                  <div style={styles.detailsGrid}>
                    ...
                    <div style={styles.detailItem}>
                      ...
                      <span style={styles.detailValue}>
                        {selectedTutor.mobilenumber}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                      <span style={styles.detailLabel}>Age</span>
                      <span style={styles.detailValue}>
                        {selectedTutor.age || "N/A"}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                      ...
                      <span style={styles.detailValue}>
                        {selectedTutor.gender
                          ? selectedTutor.gender.charAt(0).toUpperCase() +
                            selectedTutor.gender.slice(1)
                          : "N/A"}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                      ...
                      <span style={styles.detailValue}>
                        {selectedTutor.qualification || "N/A"}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                      <span style={styles.detailLabel}>Subject</span>
                      <span style={styles.detailValue}>
                        {selectedTutor.subject || "N/A"}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                    ...
                    <div style={styles.detailItem}>
                      ...
                      <span
                        style={{
                          ...styles.statusBadge,
                          ...styles[
                            `status${getStatusClass(selectedTutor.subscriptionStatus).charAt(0).toUpperCase() + getStatusClass(selectedTutor.subscriptionStatus).slice(1)}`
                          ],
                        }}
                      >
                    ...
                    <div style={styles.detailItem}>
                      ...
                      <span style={styles.detailValue}>
                        {selectedTutor.subscriptionExpiryDate
                          ? formatDate(selectedTutor.subscriptionExpiryDate)
                          : "N/A"}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                      ...
                      <span style={styles.detailValue}>
                        {selectedTutor.totalCoursesUploaded || 0}
                      </span>
                    </div>
                    <div style={styles.detailItem}>
                    ...
                    <div style={styles.addressSection}>
                      ...
                      <div style={styles.detailsGrid}>
                        <div style={styles.detailItem}>
                          ...
                          <span style={styles.detailValue}>
                            {selectedTutor.address.street || "N/A"}
                          </span>
                        </div>
                        <div style={styles.detailItem}>
                          <span style={styles.detailLabel}>City</span>
                          <span style={styles.detailValue}>
                            {selectedTutor.address.city || "N/A"}
                          </span>
                        </div>
                        <div style={styles.detailItem}>
                          <span style={styles.detailLabel}>State</span>
                          <span style={styles.detailValue}>
                            {selectedTutor.address.state || "N/A"}
                          </span>
                        </div>
                        <div style={styles.detailItem}>
                          <span style={styles.detailLabel}>Zip Code</span>
                          <span style={styles.detailValue}>
                            {selectedTutor.address.zipCode || "N/A"}
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  {selectedTutor.govtIdProofs &&
                    selectedTutor.govtIdProofs.length > 0 && (
                                  ...
                                  <div>
                                    <button
                                      ...
                                      onClick={() =>
                                        downloadImage(
                                          getImageSrc(idProof.documentImage),
                                          `${idProof.idType}_${idProof.idNumber}`,
                                        )
                                      }
                                    >
                                      Download
                  ...
                  {/* Login History */}
                  {selectedTutor.loginHistory &&
                    selectedTutor.loginHistory.length > 0 && (
                            ...
                            {selectedTutor.loginHistory
                              ...
                              .map((login, index) => (
                                <tr key={index}>
                                  ...
                                  <td style={styles.tableCell}>
                                    {login.logoutTime
                                      ? formatDate(login.logoutTime)
                                      : "N/A"}
                                  </td>
                                  <td style={styles.tableCell}>
                                    {login.sessionDuration
                                      ? `${Math.round(login.sessionDuration / 60000)} mins`
                                      : "N/A"}
                                  </td>
                                </tr>
                              ))}
