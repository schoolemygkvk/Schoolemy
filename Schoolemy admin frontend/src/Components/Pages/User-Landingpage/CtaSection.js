  ...
  const subjects = [
    {
      ...
      icon: FaAtom,
      description:
        "Explore the fundamental laws of nature and understand the universe through motion, energy, and forces.",
      color: "#3b82f6",
    ...
    },
    {
      ...
      icon: FaFlask,
      description:
        "Discover the fascinating world of matter, reactions, and the building blocks of everything around us.",
      color: "#10b981",
    ...
    },
    {
      ...
      icon: FaCalculator,
      description:
        "Master the language of logic, patterns, and problem-solving that powers science and technology.",
      color: "#f59e0b",
    ...
    const fetchClasses = async () => {
      try {
        ...
        responses.forEach((response, index) => {
          const subjectKey = subjectsList[index].key;
