...
const DemoVideoSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (formData.videoThumbnailPreview) {
        submitData.append("videoThumbnail", formData.videoThumbnailPreview);
      }

      if (formData.review.image) {
        submitData.append("reviewImage", formData.review.image);
      } else if (formData.review.imagePreview) {
        submitData.append("reviewImage", formData.review.imagePreview);
      }
