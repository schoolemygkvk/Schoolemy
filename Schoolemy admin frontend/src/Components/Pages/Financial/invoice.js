...
const InvoiceDetail = () => {
  ...
  const fetchInvoiceDetails = async () => {
    try {
      ...
      if (invoice) {
        ...
        console.warn("Invoice not found in response:", response);
  ...
  /**
   * Calculate proper GST breakdown from invoice amount.
   * Total = Course Value + 18% GST (9% CGST + 9% SGST) + 2% Transaction Fee
   * So: amount = courseValue * 1.20  =>  courseValue = amount / 1.20
   */
    ...
    return (
      <Container>
        ...
        <div style={{ textAlign: "center", padding: "3rem" }}>
          <h2>⚠️ {error || "Invoice not found"}</h2>
        </div>
      </Container>
    );
  }
            ...
            <CompanyInfo>
              ...
              <div className="contact">
                ...
                <span className="email">
                  ✉️ irainiyathiarakattalai@gmail.com
                </span>
              </div>
            </CompanyInfo>
          </InvoiceHeader>
