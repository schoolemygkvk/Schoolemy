...
/**
 * Fix can_access_materials flag for existing participants
 * This is a one-time migration utility to set the flag for participants who already have attendance
 */
