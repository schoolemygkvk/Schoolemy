// Controllers/NotificationBell/NotificationController.js
 ...
 * POST /user/notifications/emi-overdue
 */
export const sendEMIOverdueNotification = async (req, res) => {
  try {
    ...
    if (user && user.email) {
      ...
      const emailSubject = `⚠️ EMI Payment Overdue - ${courseName}`;
      const emailBody = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p><strong>⚠️ Your course access has been temporarily locked.</strong></p>
 ...
 * POST /user/notifications/emi-due-soon
 */
