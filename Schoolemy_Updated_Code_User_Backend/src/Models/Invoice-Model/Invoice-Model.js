...
import { formatAmount } from "../../Utils/amountFormatter.js";
...
const invoiceSchema = new mongoose.Schema(
  {
    ...
    amount: {
      ...
      required: true,
      min: 0,
      set: (v) => formatAmount(v), // Standard: Math.round(v * 100) / 100
    },
    currency: {
      type: String,
      enum: ["INR", "USD"],
    ...
    taxAmount: {
      type: Number,
      default: 0,
      set: (v) => formatAmount(v || 0), // Standard: Math.round(v * 100) / 100
    },
    taxPercentage: {
      type: Number,
      default: 0,
