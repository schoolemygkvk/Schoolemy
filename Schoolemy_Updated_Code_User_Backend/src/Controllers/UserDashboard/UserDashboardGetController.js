...
export const getTopBannerSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching top banner section:", error);
    res.status(500).json({
      success: false,
...
export const getWhyChooseUsSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching why choose us section:", error);
    res.status(500).json({
      success: false,
...
export const getCoursesSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching courses section:", error);
    res.status(500).json({
      success: false,
...
export const getWhatWeOfferSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching what we offer section:", error);
    res.status(500).json({
      success: false,
...
export const getDemoVideoSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching demo video section:", error);
    res.status(500).json({
      success: false,
...
export const getFeedbackSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching feedback section:", error);
    res.status(500).json({
      success: false,
...
export const getCtaSection = async (req, res) => {
  try {
    ...
    logger.error("Error fetching CTA section:", error);
    res.status(500).json({
      success: false,
