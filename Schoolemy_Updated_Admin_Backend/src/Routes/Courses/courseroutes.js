...
router.post("/create-with-s3-urls", validateCreateCourse, createCourseWithS3Urls);

// POST - Create a new course with multimedia files (LEGACY)
// LIMITED to 10MB total payload (API Gateway limit)
// May cause 413 errors with large files
// For large files (>10MB), use create-with-s3-urls instead
router.post("/createcourses", validateCreateCourse, uploadWithErrorHandling, createCourse);
...
router.get("/courses/category/:categoryName", validateCategoryName, getCoursesByCategory);

// GET - Retrieve specific course by name
router.get("/courses/:coursename", validateCourseName, getCourseByName);
...
router.put("/course/update/:coursename", validateCourseName, validateUpdateCourse, uploadWithErrorHandling, updateCourse);
router.put("/update/:coursename", validateCourseName, validateUpdateCourse, uploadWithErrorHandling, updateCourse);
...
router.put("/course/update-with-urls/:coursename", validateCourseName, validateUpdateCourse, updateCourseWithS3Urls);

// DELETE - Delete course and all associated data (question papers and S3 files)
router.delete("/course/delete/:coursename", validateCourseName, deleteCourse);
